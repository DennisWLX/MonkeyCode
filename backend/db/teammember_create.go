...
func (_c *TeamMemberCreate) SetRole(v consts.TeamMemberRole) *TeamMemberCreate {
...
func (_c *TeamMemberCreate) check() error {
	if _, ok := _c.mutation.TeamID(); !ok {
		return &ValidationError{Name: "team_id", err: errors.New(`db: missing required field "TeamMember.team_id"`)}
	}
	if _, ok := _c.mutation.UserID(); !ok {
		return &ValidationError{Name: "user_id", err: errors.New(`db: missing required field "TeamMember.user_id"`)}
	}
	if _, ok := _c.mutation.Role(); !ok {
		return &ValidationError{Name: "role", err: errors.New(`db: missing required field "TeamMember.role"`)}
	}
	if _, ok := _c.mutation.CreatedAt(); !ok {
		return &ValidationError{Name: "created_at", err: errors.New(`db: missing required field "TeamMember.created_at"`)}
	}
	if len(_c.mutation.TeamIDs()) == 0 {
		return &ValidationError{Name: "team", err: errors.New(`db: missing required edge "TeamMember.team"`)}
	}
	if len(_c.mutation.UserIDs()) == 0 {
		return &ValidationError{Name: "user", err: errors.New(`db: missing required edge "TeamMember.user"`)}
	}
	return nil
}
...
// SetTeamID sets the "team_id" field.
func (u *TeamMemberUpsert) SetTeamID(v uuid.UUID) *TeamMemberUpsert {
...
// SetUserID sets the "user_id" field.
func (u *TeamMemberUpsert) SetUserID(v uuid.UUID) *TeamMemberUpsert {
...
// SetRole sets the "role" field.
func (u *TeamMemberUpsert) SetRole(v consts.TeamMemberRole) *TeamMemberUpsert {
...
// SetCreatedAt sets the "created_at" field.
func (u *TeamMemberUpsert) SetCreatedAt(v time.Time) *TeamMemberUpsert {
	u.Set(teammember.FieldCreatedAt, v)
	return u
}

// UpdateCreatedAt sets the "created_at" field to the value that was provided on create.
func (u *TeamMemberUpsert) UpdateCreatedAt() *TeamMemberUpsert {
	u.SetExcluded(teammember.FieldCreatedAt)
	return u
}
...
//				u.SetIgnore(teammember.FieldID)
//			}),
//		).
//		Exec(ctx)
func (u *TeamMemberUpsertOne) UpdateNewValues() *TeamMemberUpsertOne {
	...
	u.create.conflict = append(u.create.conflict, sql.ResolveWith(func(s *sql.UpdateSet) {
		if _, exists := u.create.mutation.ID(); exists {
			s.SetIgnore(teammember.FieldID)
		}
	}))
	return u
}
...
// SetTeamID sets the "team_id" field.
func (u *TeamMemberUpsertOne) SetTeamID(v uuid.UUID) *TeamMemberUpsertOne {
...
// SetUserID sets the "user_id" field.
func (u *TeamMemberUpsertOne) SetUserID(v uuid.UUID) *TeamMemberUpsertOne {
	return u.Update(func(s *TeamMemberUpsert) {
		s.SetUserID(v)
	})
}
...
// SetRole sets the "role" field.
func (u *TeamMemberUpsertOne) SetRole(v consts.TeamMemberRole) *TeamMemberUpsertOne {
	return u.Update(func(s *TeamMemberUpsert) {
		s.SetRole(v)
	})
}
...
// SetCreatedAt sets the "created_at" field.
func (u *TeamMemberUpsertOne) SetCreatedAt(v time.Time) *TeamMemberUpsertOne {
	return u.Update(func(s *TeamMemberUpsert) {
		s.SetCreatedAt(v)
	})
}
...
// UpdateCreatedAt sets the "created_at" field to the value that was provided on create.
func (u *TeamMemberUpsertOne) UpdateCreatedAt() *TeamMemberUpsertOne {
	return u.Update(func(s *TeamMemberUpsert) {
		s.UpdateCreatedAt()
	})
}
...
func (u *TeamMemberUpsertOne) Exec(ctx context.Context) error {
	if len(u.create.conflict) == 0 {
		return errors.New("db: missing options for TeamMemberCreate.OnConflict")
	}
...
func (u *TeamMemberUpsertOne) ID(ctx context.Context) (id uuid.UUID, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		// In case of "ON CONFLICT", there is no way to get back non-numeric ID
		// fields from the database since MySQL does not support the RETURNING clause.
		return id, errors.New("db: TeamMemberUpsertOne.ID is not supported by MySQL driver. Use TeamMemberUpsertOne.Exec instead")
	}
...
func (u *TeamMemberUpsertOne) IDX(ctx context.Context) uuid.UUID {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
...
// SetTeamID sets the "team_id" field.
func (u *TeamMemberUpsertBulk) SetTeamID(v uuid.UUID) *TeamMemberUpsertBulk {
	return u.Update(func(s *TeamMemberUpsert) {
		s.SetTeamID(v)
	})
}
...
// SetUserID sets the "user_id" field.
func (u *TeamMemberUpsertBulk) SetUserID(v uuid.UUID) *TeamMemberUpsertBulk {
	return u.Update(func(s *TeamMemberUpsert) {
		s.SetUserID(v)
	})
}
...
// SetRole sets the "role" field.
func (u *TeamMemberUpsertBulk) SetRole(v consts.TeamMemberRole) *TeamMemberUpsertBulk {
	return u.Update(func(s *TeamMemberUpsert) {
		s.SetRole(v)
	})
}
...
// SetCreatedAt sets the "created_at" field.
func (u *TeamMemberUpsertBulk) SetCreatedAt(v time.Time) *TeamMemberUpsertBulk {
	return u.Update(func(s *TeamMemberUpsert) {
		s.SetCreatedAt(v)
	})
}
...
// UpdateCreatedAt sets the "created_at" field to the value that was provided on create.
func (u *TeamMemberUpsertBulk) UpdateCreatedAt() *TeamMemberUpsertBulk {
	return u.Update(func(s *TeamMemberUpsert) {
		s.UpdateCreatedAt()
	})
}
...
func (u *TeamMemberUpsertBulk) Exec(ctx context.Context) error {
	...
	for i, b := range u.create.builders {
		if len(b.conflict) != 0 {
			return fmt.Errorf("db: OnConflict was set for builder %d. Set it on the TeamMemberCreateBulk instead", i)
		}
	}
	if len(u.create.conflict) == 0 {
		return errors.New("db: missing options for TeamMemberCreateBulk.OnConflict")
	}
	return u.create.Exec(ctx)
}
